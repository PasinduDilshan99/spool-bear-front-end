...
import { teamData } from "@/data/about-us-page-data";
                ...
                <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-2 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                  {[
                    ...
                    <a
                      key={si}
                      href={href}
                      className="w-8 h-8 rounded-full bg-white text-[#FF5000] flex items-center justify-center hover:bg-[#FF5000] hover:text-white transition-colors duration-300"
                    >
                      <Icon size={14} />
                    </a>
                  ))}
