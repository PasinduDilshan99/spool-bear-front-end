...
export const PrivacyHero = ({ lastUpdated }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative inline-flex items-center justify-center mb-6">
        <div className="absolute inset-0 rounded-3xl blur-xl opacity-30" style={{ background: "#FF5000", transform: "scale(1.3)" }} />
      ...
      <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-50 border border-orange-100 mb-5">
        <Lock size={13} className="text-[#FF5000]" />
        <span className="text-xs font-semibold text-[#FF5000] uppercase tracking-widest">Data Protection</span>
      </div>

      <h1
        className="font-black text-[#1C1714] mb-4 tracking-tight leading-none"
        style={{ fontSize: "clamp(36px, 5.5vw, 60px)", fontFamily: "'Fraunces','Georgia',serif", letterSpacing: "-0.03em" }}
      >
        Privacy{" "}
        <span style={{ background: "linear-gradient(135deg,#FF5000 0%,#FF8C42 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
          Policy
        </span>
      </h1>

      <p className="text-[#6B5F56] max-w-xl mx-auto leading-relaxed" style={{ fontSize: "clamp(15px,1.8vw,17px)" }}>
