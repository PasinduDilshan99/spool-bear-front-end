...
import { TERMS_AND_CONDITIONS_PAGE_PATH, FAQ_PAGE_PATH, CONTACT_US_PAGE_PATH } from "@/utils/urls";

const links = [
  { href: TERMS_AND_CONDITIONS_PAGE_PATH, label: "Terms & Conditions", icon: FileText   },
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-[#1C1714] to-[#2E2520] rounded-3xl p-6 md:p-8 mb-6 text-center relative overflow-hidden">
        <div className="absolute -top-10 -right-10 w-48 h-48 rounded-full opacity-10" style={{ background: "#FF5000" }} />
        <div className="absolute -bottom-10 -left-10 w-32 h-32 rounded-full opacity-5" style={{ background: "#FF5000" }} />
        <div className="relative inline-flex items-center gap-2 mb-3">
          <ShieldCheck size={16} className="text-[#FF7A40]" />
          <span className="text-xs font-bold text-[#FF7A40] uppercase tracking-widest">Privacy Commitment</span>
        </div>
        <p className="relative text-[#D6CEC6] text-sm leading-relaxed max-w-xl mx-auto">
          ...
          and being <strong className="text-white">transparent about our data practices</strong> at all times.
        </p>
      </div>
