          ...
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-6 md:p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="w-3/4 h-12 bg-gray-300 rounded animate-pulse" />
              ...
              {/* Image Skeleton */}
              <div className="w-full h-96 bg-gray-300 rounded-2xl animate-pulse my-8" />

              {/* Content Skeleton */}
              <div className="space-y-4">
                <div className="w-full h-4 bg-gray-300 rounded animate-pulse" />
                <div className="w-5/6 h-4 bg-gray-300 rounded animate-pulse" />
                <div className="w-4/6 h-4 bg-gray-300 rounded animate-pulse" />
                <div className="w-full h-4 bg-gray-300 rounded animate-pulse mt-4" />
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-6">
              <div className="flex flex-col items-center">
                ...
                <div className="w-32 h-6 bg-gray-300 rounded animate-pulse mb-2" />
                <div className="w-24 h-4 bg-gray-300 rounded animate-pulse mb-4" />
