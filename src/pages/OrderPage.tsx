...
export default function OrdersPage() {
  ...
  const reviewEligibleStatuses = ["DELIVERED", "CONFIRMED", "RETURNED"];
  ...
  const isEligibleForReview = (order: Order) => {
    return reviewEligibleStatuses.includes(order.orderStatus);
  };
                      ...
                      <div>
                        {isEligibleForReview(order) && (
                          <button
                            ...
                            className="px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 text-sm font-medium flex items-center gap-2"
                          >
                            <svg
                              className="w-4 h-4"
                              fill="currentColor"
