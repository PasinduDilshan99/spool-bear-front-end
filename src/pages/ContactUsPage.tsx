      ...
      <section className="relative py-20 md:py-28 lg:py-36 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1
              className="font-black text-[clamp(42px,5vw,72px)] tracking-[-0.02em] mb-6"
              style={{ color: spoolbearTheme.colors.text }}
            >
              Let&apos;s{" "}
              <span style={{ color: spoolbearTheme.colors.accent }}>
                Connect
              </span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                >
                  <div style={{ color: spoolbearTheme.colors.accent }}>
                    {info.icon}
                  </div>
                </div>
                <h3
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      className="block text-xs font-black tracking-wider mb-2"
                      style={{ color: spoolbearTheme.colors.muted }}
                    >
                      FULL NAME *
                    </label>
