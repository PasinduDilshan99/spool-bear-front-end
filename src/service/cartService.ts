...
class CartService {
  ...
  async createCart(request: CreateCartRequest): Promise<ApiResponse<{ cardId: number; productsCartResponse: CartItem }>> {
  ...
  async addProduct(request: AddProductRequest): Promise<ApiResponse<CartItem[]>> {
  ...
  async removeProduct(request: RemoveProductRequest): Promise<ApiResponse<CartItem[]>> {
  ...
  async clearCart(request: ClearCartRequest): Promise<ApiResponse<{ message: string }>> {
